...
<link href="/resource/skin/pink.flag/jplayer.pink.flag.css" rel="stylesheet" type="text/css" />
					...
					<div class="jp-interface">
						...
						<div class="jp-controls-holder">
							<ul class="jp-controls">
								...
								<li><a href="javascript:;" class="jp-mute" tabindex="1" title="静音">锁定</a></li>
								<li><a href="javascript:;" class="jp-unmute" tabindex="1" title="取消静音">解锁</a></li>
							...
							<ul class="jp-toggles">
								...
								<li><a href="javascript:;" class="jp-restore-screen" tabindex="1" title="恢复屏幕">恢复屏幕</a></li>
								<li><a href="javascript:;" class="jp-repeat" tabindex="1" title="重复">重复</a></li>
								<li><a href="javascript:;" class="jp-repeat-off" tabindex="1" title="结束重复">结束重复</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="jp-no-solution">
					<span>请更新您的flash插件</span>
					请更新您的flash插件 <a href="http://get.adobe.com/flashplayer/" target="_blank">点击更新</a>.
				</div>
			</div>
		</div>
							...
							<li class="reply" data-author="${cm1.user.userName}">
								...
								<div class="mbs">
									<strong class="mrs"><a
										...
										class="show-user-card " title="${cm1.user.userName}">${cm1.user.userName}</a>
											...
											value="${cm1.commentDate}" pattern="yyyy-MM-dd HH:mm" />
									</span>
								</div>
									...
									<c:forEach items="${nestedCommentList}" var="cm2">
										<c:if test="${cm2.comment.commentId eq cm1.commentId}">
											<li class="reply" data-author="${cm2.user.userName}">
												...
												<div
													class="said-content editor-content reply-editor-content">${cm2.commentContent}</div>
											</li>
										</c:if>
									</c:forEach>
								</ul>
								...
								<div class="st">
									<div style="display: none;" class="frame">
										<form id="form2" class="form1 reply-form" method="post"
											...
											<p class="text">
												...
												<input type="hidden" name="courseTimeId"
													value="${lesson.courseId}" /> <input type="hidden"
													name="parentId" value="${cm1.commentId}" />
											</p>
										</form>
										<p align="right">
